...
> 853.9s	7276	-- Module opencv_wechat_qrcode disabled because opencv_dnn dependency can't be resolved!
> ```
...
出现了下面这个问题 是因为使用了ubuntu22.04

> denseflow: error while loading shared libraries: libboost_filesystem.so.1.71.0: cannot open shared object file: No such file or directory
